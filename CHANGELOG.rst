...
1.0.1 (2026-07-14)
===================
  - Изменено формирование значения тега 1265 Отраслевых реквизитов

1.0.0 (2026-07-14)
===================
  - Добавлена поддержка КОМТЕТ Сканер маркировки
  - Переход на Shop API v2

0.16.2 (2026-07-10)
===================
  - Правка проверки кодов маркировок

0.16.1 (2026-06-22)
===================
  - Изменения для повышения безопасности плагина
  - Исключение папки .git из подмодулей при сброке

0.16.0 (2025-12-03)
===================
  - Использование komtet-kassa-php-sdk версии 11.0.0
...
0.14.0 (2025-01-29)
===================
  - Добавлена настройка "Выдавать чеки на заказы, созданные после этой даты"
